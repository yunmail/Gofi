...
func (cq *ConfigurationQuery) Order(o ...Order) *ConfigurationQuery {
...
func (cq *ConfigurationQuery) OnlyXID(ctx context.Context) int {
...
//		GroupBy(configuration.FieldVersion).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
//
//	client.Configuration.Query().
//		Select(configuration.FieldVersion).
//		Scan(ctx, &v)
//
...
func (cgb *ConfigurationGroupBy) Aggregate(fns ...Aggregate) *ConfigurationGroupBy {
